...
#' above.
#'
#' @param mode Character.  One of \code{c("even", "log", "exp", "ecdf",
#' "posexp", "negexp", "poslog", "neglog")}. \code{"even"} will create evenly
#' spaced levels.  \code{"log"} will create levels which are more closely
#' spaced at the extremes, while \code{"exp"} does the opposite.  The pos- or
...
#'
#' @note This function is called by \code{\link{corSpectra}} and
#' \code{\link{covSpectra}} if levels are not provided to those functions.
#'
#' @author Bryan A. Hanson, DePauw University. \email{hanson@@depauw.edu}
#'
#' @importFrom graphics hist par layout
